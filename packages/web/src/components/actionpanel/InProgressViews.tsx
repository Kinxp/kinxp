...
export const InProgressViews: React.FC<InProgressViewsProps> = (props) => {
  switch (props.appState) {
    case AppState.ORDER_CREATED:
      return <FundOrderView orderId={props.newlyCreatedOrderId!} ethAmount={props.ethAmount} onFund={props.onFund} />;
    ...
    default:
      return <ProgressView logs={props.logs} lzTxHash={props.lzTxHash} />;
  }
};
