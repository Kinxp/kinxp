...
import {HederaTokenService} from "./hedera-hts/HederaTokenService.sol";
import {IHederaTokenService} from "./hedera-hts/IHederaTokenService.sol";
import {HederaResponseCodes} from "./hedera-hts/HederaResponseCodes.sol";
 ...
 */
contract MyHTSToken is HederaTokenService, Ownable {
    ...
    uint256 private constant KEY_TYPE_ADMIN = 1 << 0;
    uint256 private constant KEY_TYPE_SUPPLY = 1 << 4;
    ...
    function createNFTCollection(
        ...
        keys[1] = _contractKey(KEY_TYPE_ADMIN);
